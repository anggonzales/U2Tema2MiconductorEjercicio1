...
// Se crea un JSONObjet
                                ...
                                .setNeutralButton("Aceptar",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                Button btnavisar =findViewById(R.id.btnavisar);
                                                btnavisar.setVisibility(View.VISIBLE);
    ...
    public void avisarcliente(View view) {
        Button btnavisar = findViewById(R.id.btnavisar);
        JSONObject misdatos = new JSONObject();
        try {
            misdatos.put("id",App.getidcliente());
        ...
        mSocket.emit("avisar", misdatos, new Ack() {
            @Override
            public void call(Object... args) {
                String res = (String) args[0];
                if (res.equals("OK")) Log.i("mimensaje", "Se envio correctamente");
